...
PACKAGE ?= helm-headlamp
XRD_DIR := apis/headlamp
COMPOSITION := $(XRD_DIR)/composition.yaml
DEFINITION := $(XRD_DIR)/definition.yaml
EXAMPLE_DEFAULT := examples/headlamp/standard.yaml
...
EXAMPLES := \
    examples/headlamp/minimal.yaml:: \
    examples/headlamp/standard.yaml::
...
render\:%:
	@example="examples/headlamp/$*.yaml"; \
	up composition render --xrd=$(DEFINITION) $(COMPOSITION) $$example
